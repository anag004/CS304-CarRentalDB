...
insert into rentals values ('5', 8,  934, 'Lorem Ipsum6', 3640, to_date('2015/12/15', 'yyyy/mm/dd'), '5010');

insert into rentals values ('6', 16,  992, 'Lorem Ipsum7', 4973, to_date('2013/10/16', 'yyyy/mm/dd'), '5006');

insert into rentals values ('7', 10,  991, 'Lorem Ipsum8', 6927, to_date('2015/10/22', 'yyyy/mm/dd'), '5019');

insert into rentals values ('8', 20,  1016, 'Lorem Ipsum9', 9823, to_date('2011/8/10', 'yyyy/mm/dd'), '5027');

insert into rentals values ('9', 13,  1013, 'Lorem Ipsum10', 1199, to_date('2013/11/19', 'yyyy/mm/dd'), '5034');

insert into rentals values ('10', 26,  995, 'Lorem Ipsum11', 9040, to_date('2019/10/25', 'yyyy/mm/dd'), '5005');

insert into rentals values ('11', 25,  958, 'Lorem Ipsum12', 5186, to_date('2017/1/24', 'yyyy/mm/dd'), '5013');

insert into rentals values ('12', 33,  958, 'Lorem Ipsum13', 8801, to_date('2018/8/24', 'yyyy/mm/dd'), '5020');

insert into rentals values ('13', 14,  945, 'Lorem Ipsum14', 8547, to_date('2013/11/24', 'yyyy/mm/dd'), '5026');

insert into rentals values ('14', 6, 1042, 'Lorem Ipsum15', 5356, to_date('2019/9/26', 'yyyy/mm/dd'), '5032');

insert into rentals values ('15', 8,  1048, 'Lorem Ipsum16', 6736, to_date('2012/5/8', 'yyyy/mm/dd'), '5038');

insert into rentals values ('16', 25,  1039, 'Lorem Ipsum17', 7203, to_date('2018/1/18', 'yyyy/mm/dd'), '5016');

insert into rentals values ('17', 7,  966, 'Lorem Ipsum18', 1143, to_date('2019/1/15', 'yyyy/mm/dd'), '5025');

insert into rentals values ('18', 3, 986, 'Lorem Ipsum19', 6553, to_date('2014/1/14', 'yyyy/mm/dd'), '5003');

insert into rentals values ('19', 18, 1009, 'Lorem Ipsum20', 4828, to_date('2019/9/11', 'yyyy/mm/dd'), '5002');

insert into rentals values ('20', 16,  885, 'Lorem Ipsum21', 4363, to_date('2010/3/22', 'yyyy/mm/dd'), '5008');

insert into rentals values ('21', 23, 1014, 'Lorem Ipsum22', 9894, to_date('2014/10/29', 'yyyy/mm/dd'), '5000');

insert into rentals values ('22', 18,  978, 'Lorem Ipsum23', 2738, to_date('2011/6/11', 'yyyy/mm/dd'), '5036');

insert into rentals values ('23', 34,  925, 'Lorem Ipsum24', 7944, to_date('2011/11/22', 'yyyy/mm/dd'), '5035');

insert into rentals values ('24', 4,  869, 'Lorem Ipsum25', 4039, to_date('2018/5/24', 'yyyy/mm/dd'), '5001');

insert into rentals values ('25', 24,  1016, 'Lorem Ipsum26', 4970, to_date('2016/5/26', 'yyyy/mm/dd'), '5017');

insert into rentals values ('26', 10,  960, 'Lorem Ipsum27', 2660, to_date('2012/11/29', 'yyyy/mm/dd'), '5011');

insert into rentals values ('27', 22,  885, 'Lorem Ipsum28', 8154, to_date('2012/11/10', 'yyyy/mm/dd'), '5029');

insert into rentals values ('28', 10,  1034, 'Lorem Ipsum29', 2453, to_date('2014/6/9', 'yyyy/mm/dd'), '5033');

insert into rentals values ('29', 7, 972, 'Lorem Ipsum30', 9918, to_date('2018/8/10', 'yyyy/mm/dd'), '5022');

insert into rentals values ('30', 33, 902, 'Lorem Ipsum31', 4482, to_date('2019/7/28', 'yyyy/mm/dd'), '5007');
