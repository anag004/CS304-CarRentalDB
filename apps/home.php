...
<button onclick="window.location.href='customer/view_vehicles.php';">View Vehicles</button>
<button onclick="window.location.href='customer/make_reservations.php';">Make Reservations</button>
<hr>
<h3> Clerk Actions </h3>
